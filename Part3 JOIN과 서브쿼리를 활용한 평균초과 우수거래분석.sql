...
select s.sale_id, s.sale_date, s.sales_type, s.sale_amount, s.quantity, s.payment_status,
p.product_name, c.customer_name, c.customer_type, c.customer_region from sales s 
